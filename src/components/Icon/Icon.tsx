      ...
      case 'volume-off':
        return (
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M5.586 15H4a1 1 0 01-1-1v-4a1 1 0 011-1h1.586l4.707-4.707C10.923 3.663 12 4.109 12 5v14c0 .891-1.077 1.337-1.707.707L5.586 15zm10.707-6.293l-4 4m0-4l4 4"
          />
        );
      case 'info':
        return (
